...
class userSignUpcontroller extends Controller
{
    ...
    public function index()
    {
        ...
        $dtuserSignUp = userSignUp::where('email', $userEmail)->get();
    ...
    public function store(Request $request)
{
    ...
    return redirect('/user_halaman')->with('success', 'Sign-up berhasil!'); // Contoh redirect ke halaman dashboard dengan pesan sukses
}
